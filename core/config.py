...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/mark_train_1.txt"
...
__C.TEST.ANNOT_PATH             = "./data/dataset/mark_test_1.txt"
...
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=1.7385.ckpt-50"
